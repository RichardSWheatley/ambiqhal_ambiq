 ...
 * the next multiple of AM_HAL_CC312_DMA_ALIGNMENT, keeping their sizes equal.
 * Matches am_hal_cc312_aes_context_t / am_hal_cc312_aes_gcm_context_t.
 */
...
}__attribute__((aligned(AM_HAL_CC312_DMA_ALIGNMENT))) mbedtls_chacha_user_context;
